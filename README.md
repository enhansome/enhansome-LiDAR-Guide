...
![Last-Commit](https://img.shields.io/github/last-commit/mikeroyal/lidar-guide?style=for-the-badge)
...
1. [LiDAR Learning Resources](https://github.com/mikeroyal/LiDAR-Guide#lidar-learning-resources) ⭐ 108 | 🐛 0 | 🌐 Python | 📅 2024-01-04

2. [LiDAR Tools & Frameworks](https://github.com/mikeroyal/LiDAR-Guide#lidar-tools--frameworks) ⭐ 108 | 🐛 0 | 🌐 Python | 📅 2024-01-04

3. [Machine Learning](https://github.com/mikeroyal/LiDAR-Guide#machine-learning) ⭐ 108 | 🐛 0 | 🌐 Python | 📅 2024-01-04

4. [CUDA Development](https://github.com/mikeroyal/LiDAR-Guide#cuda-development) ⭐ 108 | 🐛 0 | 🌐 Python | 📅 2024-01-04

5. [Robotics](https://github.com/mikeroyal/LiDAR-Guide#robotics) ⭐ 108 | 🐛 0 | 🌐 Python | 📅 2024-01-04

6. [MATLAB Development](https://github.com/mikeroyal/LiDAR-Guide#matlab-development) ⭐ 108 | 🐛 0 | 🌐 Python | 📅 2024-01-04
...
[The Robotics Library (RL)](https://github.com/roboticslibrary/rl) ⭐ 1,205 | 🐛 54 | 🌐 C++ | 📅 2025-04-15 is a self-contained C++ library for robot kinematics, motion planning and control. It covers mathematics, kinematics and dynamics, hardware abstraction, motion planning, collision detection, and visualization.RL runs on many different systems, including Linux, macOS, and Windows. It uses CMake as a build system and can be compiled with Clang, GCC, and Visual Studio.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/LiDAR-Guide/pulls) ⭐ 108 | 🐛 0 | 🌐 Python | 📅 2024-01-04.
